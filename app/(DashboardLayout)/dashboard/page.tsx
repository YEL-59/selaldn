  ...
  return (
    ...
    >
      ...
      <div className="lg:col-span-6 flex flex-col gap-6">
        ...
        <motion.div
          variants={fadeInUp}
          className="p-5 sm:p-6 rounded-[12px] border border-[#EAEAEA] bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.02)] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-0"
        >
          <div className="flex flex-col gap-1 w-full sm:w-auto">
            <div className="flex items-center gap-3">
              <h2 className="text-xl sm:text-2xl font-bold text-[#37003C] tracking-tight">
                Gameweek 12
              </h2>
          ...
          <div className="flex items-center justify-between sm:justify-end gap-6 sm:gap-8 w-full sm:w-auto border-t sm:border-t-0 pt-4 sm:pt-0 border-[#f3f4f6]">
            <div className="flex flex-col items-start sm:items-end">
              ...
              <div className="flex items-center gap-2 text-[#10B981] font-bold">
                ...
                <span className="text-sm mt-0.5 uppercase tracking-wide">
                  Top 1% Global
                </span>
              </div>
            </div>

            <div className="relative w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center drop-shadow-sm shrink-0">
              ...
              <span className="absolute text-lg sm:text-xl font-bold text-[#37003C]">
                84
              </span>
            </div>
          </div>
