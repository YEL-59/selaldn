...
import { TrendingUp, Zap, Star, Info, ChevronDown } from "lucide-react";
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          >
            <div className="relative shrink-0">
              <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-white shadow-xl relative">
                <Image
          ...
          <motion.div
            variants={fadeInUp}
            className=" rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col gap-6 flex-1"
          >
            <div className="flex justify-between items-center px-2">
              <h3 className="font-semibold text-[#1e1b4b] text-lg">
                Optimised Starting XI
              </h3>
...
const CaptainCard = ({
  ...
  >
    ...
    <div className="bg-emerald-50 py-2 px-4 rounded-xl flex justify-between items-center border border-emerald-100/50">
      <span className="text-xs font-bold text-[#028A4B]">GW24</span>
...
const OptimisedBenchItem = ({ num, name, team, score, image }: any) => (
  <div className="flex items-center gap-4 bg-[#F1F5F9]/50 p-3 rounded-2xl border border-transparent hover:border-purple-100 transition-all group cursor-pointer">
    ...
    <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-white shadow-lg ring-1 ring-gray-100 group-hover:scale-105 transition-transform relative">
      <Image
        src={image}
        alt={name}
        width={48}
