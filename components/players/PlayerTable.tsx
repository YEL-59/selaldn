                ...
                <td className="py-4 px-4 text-center">
                  <span
                    className={cn(
                      ...
                      parseFloat(player.form.toString()) >= 7
                        ? "text-[#00FF88]"
                        : "text-gray-900",
                    )}
                  >
                  ...
                  <div className="flex items-center justify-center gap-1.5">
                    {player.fixtures.map((fix, i) => (
                      <div
                        key={i}
                        className={cn(
                          "px-2 px-1 rounded-[5px] border text-[9px] font-semibold uppercase tracking-tight w-16 text-center h-7 flex items-center justify-center",
                          difficultyColors[fix.difficulty] ||
                            difficultyColors[4],
                        )}
                      >
                        {fix.team} ({fix.venue})
