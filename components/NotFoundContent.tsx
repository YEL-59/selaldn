...
export const NotFoundContent = ({ 
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center p-6 ${!isAuth ? 'min-h-[70vh]' : 'w-full py-12'}`}>
      <motion.div
      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none">Status: 404</span>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
             ...
             <span className="text-xs font-bold leading-none">VAR Check: No Page Found</span>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-xs font-bold text-gray-500 uppercase tracking-[0.2em]">Offside Trap</span>
            <div className="h-px w-8 bg-gray-200" />
        </div>

        <h1 className="text-4xl md:text-5xl font-black text-[#1e1b4b] mb-4 tracking-tight">
          {title || "Page"} <span className="text-transparent bg-clip-text bg-linear-to-r from-[#2E004B] to-[#8E7AB5]">{title ? "Not Found" : "Out of Bounds"}</span>
        </h1>
